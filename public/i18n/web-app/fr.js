var fr = {
    ...
    alarms: {
        ...
        message: "Message",
        entryDate: "Date",
        ackDate: "Acquittement",
        clearDate: "Effacement"
    },
    organizations: {
        newOrganization: "Nouvelle Organisation",
        name: "Nom d'organisation",
        action: "Action",
        modalTitle: "Paramètres de l'organisation"
    },
    settings: {
        ...
        emailLists: {
            title: "Gestion des listes d'e-mails",
            new_emailList_button: "Nouvelle liste e-mail",
            organization: "Organisation",
            name: "Nom de la liste",
            count: "Nombre d'adresse e-mails",
            action: "Action",
            modal_title: "Paramètres de la listes d'e-mails",
            emailListName: "Nom de la liste",
            emails: "Adresses e-mails"
        },
        api: {
            ...
            link_api_text: "Lier l'API à l'organisation ",
            organization: "Organisation",
            action: "Action",
