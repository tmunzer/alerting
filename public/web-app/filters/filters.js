...
angular.module('CustomFilters').filter('userStatus', function () {
    return function (input) {
        if (input === "true" || input === true) return '<i class="material-icons md-18 color-success">done</i>';
        else if (input === "false" || input === false) return '<i class="material-icons md-18 color-danger">not_interested</i>';
        else return "";
    }
});
